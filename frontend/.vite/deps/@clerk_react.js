...
import {
  require_client
} from "./chunk-5P4VMDIW.js";
import {
  require_react_dom
} from "./chunk-ZJYAJ63K.js";
import {
  require_react
...
function createErrorTypeGuard(ErrorClass) {
  function typeGuard(error) {
    ...
    if (ErrorClass.kind && typeof target === "object" && target !== null && "constructor" in target) {
      if (((_a16 = target.constructor) == null ? void 0 : _a16.kind) === ErrorClass.kind) return true;
    }
...
var ClerkAPIError = (_a3 = class {
  constructor(json) {
    ...
    const parsedError = {
      ...
      meta: {
        paramName: (_a16 = json.meta) == null ? void 0 : _a16.param_name,
...
var isReverificationHint = (result) => {
  var _a16, _b;
  return result && typeof result === "object" && "clerk_error" in result && ((_a16 = result.clerk_error) == null ? void 0 : _a16.type) === "forbidden" && ((_b = result.clerk_error) == null ? void 0 : _b.reason) === REVERIFICATION_REASON;
};
...
var deriveFromClientSideState = (state) => {
  ...
  const sessionStatus = (_a16 = state.session) == null ? void 0 : _a16.status;
...
var FocusManager = (_a5 = class extends Subscribable {
  ...
  isFocused() {
    ...
    return ((_a16 = globalThis.document) == null ? void 0 : _a16.visibilityState) !== "hidden";
  }
...
function createRetryer(config) {
  ...
  const cancel = (cancelOptions) => {
    ...
    if (!isResolved()) {
      ...
      reject(error);
      (_a16 = config.onCancel) == null ? void 0 : _a16.call(config, error);
    }
  };
  const cancelRetry = () => {
  ...
  const pause = () => {
    return new Promise((continueResolve) => {
      ...
      (_a16 = config.onPause) == null ? void 0 : _a16.call(config);
    }).then(() => {
      var _a16;
      continueFn = void 0;
      if (!isResolved()) {
        (_a16 = config.onContinue) == null ? void 0 : _a16.call(config);
      }
    });
  };
  const run = () => {
    ...
    Promise.resolve(promiseOrValue).then(resolve).catch((error) => {
      ...
      failureCount++;
      (_a16 = config.onFail) == null ? void 0 : _a16.call(config, failureCount, error);
      sleep(delay).then(() => {
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      ...
      const direction = (_c = (_b = (_a16 = context.fetchOptions) == null ? void 0 : _a16.meta) == null ? void 0 : _b.fetchMore) == null ? void 0 : _c.direction;
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a17, _b2;
          return (_b2 = (_a17 = context.options).persister) == null ? void 0 : _b2.call(
            _a17,
            fetchFn,
            {
              client: context.client,
...
function getPreviousPageParam(options, { pages, pageParams }) {
  var _a16;
  return pages.length > 0 ? (_a16 = options.getPreviousPageParam) == null ? void 0 : _a16.call(options, pages[0], pages, pageParams[0], pageParams) : void 0;
}
...
var Query = (_a9 = class extends Removable {
  ...
  get promise() {
    var _a16;
    return (_a16 = __privateGet(this, _retryer)) == null ? void 0 : _a16.promise;
  }
  setOptions(options) {
  ...
  cancel(options) {
    var _a16, _b;
    const promise = (_a16 = __privateGet(this, _retryer)) == null ? void 0 : _a16.promise;
  ...
  onFocus() {
    ...
    (_a16 = __privateGet(this, _retryer)) == null ? void 0 : _a16.continue();
  }
  onOnline() {
    var _a16;
  ...
  async fetch(options, fetchOptions) {
    ...
    ((_a16 = __privateGet(this, _retryer)) == null ? void 0 : _a16.status()) !== "rejected") {
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if ((prevResult == null ? void 0 : prevResult.isPlaceholderData) && options.placeholderData === (prevResultOptions == null ? void 0 : prevResultOptions.placeholderData)) {
        ...
        placeholderData = typeof options.placeholderData === "function" ? options.placeholderData(
          (_a16 = __privateGet(this, _lastQueryWithDefinedData)) == null ? void 0 : _a16.state.data,
...
var InfiniteQueryObserver = class extends QueryObserver {
  ...
  createResult(query, options) {
    ...
    const fetchDirection = (_b = (_a16 = state.fetchMeta) == null ? void 0 : _a16.fetchMore) == null ? void 0 : _b.direction;
...
var Mutation = (_a11 = class extends Removable {
  ...
  continue() {
    var _a16;
    return ((_a16 = __privateGet(this, _retryer2)) == null ? void 0 : _a16.continue()) ?? // continuing a mutation assumes that variables are set, mutation must have been dehydrated before
  ...
  async execute(variables) {
    ...
    try {
      if (restored) {
        ...
        const context = await ((_b = (_a16 = this.options).onMutate) == null ? void 0 : _b.call(
          _a16,
          variables,
          mutationFnContext
        ));
...
var MutationCache = (_a12 = class extends Subscribable {
  ...
  runNext(mutation) {
    ...
    const scope = scopeFor(mutation);
    if (typeof scope === "string") {
      const foundMutation = (_a16 = __privateGet(this, _scopes).get(scope)) == null ? void 0 : _a16.find((m) => m !== mutation && m.state.isPaused);
...
function scopeFor(mutation) {
  var _a16;
  return (_a16 = mutation.options.scope) == null ? void 0 : _a16.id;
}
...
var QueryClient = (_a14 = class {
  ...
  getQueryData(queryKey) {
    ...
    return (_a16 = __privateGet(this, _queryCache).get(options.queryHash)) == null ? void 0 : _a16.state.data;
  }
  ...
  getQueryState(queryKey) {
    var _a16;
    const options = this.defaultQueryOptions({ queryKey });
    return (_a16 = __privateGet(this, _queryCache).get(
      options.queryHash
    )) == null ? void 0 : _a16.state;
  }
...
var usePagesOrInfinite = (params) => {
  ...
  const { data, count, page } = (0, import_react.useMemo)(() => {
    ...
    if (triggerInfinite) {
      ...
      const pages = queriesEnabled ? ((_a17 = infiniteQuery.data) == null ? void 0 : _a17.pages) ?? (cachedData == null ? void 0 : cachedData.pages) ?? [] : (cachedData == null ? void 0 : cachedData.pages) ?? [];
    ...
    forceUpdateCounter,
    triggerInfinite,
    (_a16 = infiniteQuery.data) == null ? void 0 : _a16.pages,
  ...
  const fetchPage = (0, import_react.useCallback)((numberOrgFn) => {
    ...
    if (triggerInfinite) {
      ...
      const cachedData = queryClient.getQueryData(infiniteQueryKey);
      if (targetCount - (((_a17 = infiniteQuery.data) == null ? void 0 : _a17.pages) ?? (cachedData == null ? void 0 : cachedData.pages) ?? []).length > 0) infiniteQuery.fetchNextPage({ cancelRefetch: false });
      return;
    }
...
function useAPIKeys(params) {
  ...
  (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled("useAPIKeys"));
  const hookParams = {
  ...
  return usePagesOrInfinite({
    fetcher: ((_b = clerk.apiKeys) == null ? void 0 : _b.getAll) ? (params$1) => clerk.apiKeys.getAll({
      ...params$1,
...
function useOAuthConsent(params) {
  ...
  (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled(HOOK_NAME$2));
...
function useSessionBase() {
  ...
  const getInitialState = (0, import_react.useCallback)(() => {
    var _a16;
    return initialState ? (_a16 = deriveFromSsrInitialState(initialState)) == null ? void 0 : _a16.session : void 0;
  }, [initialState]);
  return (0, import_react.useSyncExternalStore)((0, import_react.useCallback)((callback) => clerk.addListener(callback, { skipInitialEmit: true }), [clerk]), (0, import_react.useCallback)(() => {
    if (!clerk.loaded || !clerk.__internal_lastEmittedResources) return getInitialState();
...
function useAttemptToEnableOrganizations(caller) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    (_a16 = clerk.__internal_attemptToEnableEnvironmentSetting) == null ? void 0 : _a16.call(clerk, {
      for: "organizations",
      caller
    });
  }, [clerk, caller]);
...
function useOrganization(params) {
  ...
  const clerk = useClerkInstanceContext();
  (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled("useOrganization"));
...
function useOrganizationCreationDefaults(params = {}) {
  ...
  const clerk = useClerkInstanceContext();
  const user = useUserBase();
  const featureEnabled = ((_c = (_b = (_a16 = clerk.__internal_environment) == null ? void 0 : _a16.organizationSettings) == null ? void 0 : _b.organizationCreationDefaults) == null ? void 0 : _c.enabled) ?? false;
...
function useOrganizationList(params) {
  ...
  const clerk = useClerkInstanceContext();
  const user = useUserBase();
  (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled("useOrganizationList"));
...
var useSession = () => {
  ...
  const session = useSessionBase();
  const clerk = useClerkInstanceContext();
  (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled(hookName$2));
...
var useSessionList = () => {
  ...
  (_a16 = useClerkInstanceContext().telemetry) == null ? void 0 : _a16.record(eventMethodCalled(hookName$1));
  if (!client) return {
    isLoaded: false,
    sessions: void 0,
    setActive: void 0
...
function useUser() {
  ...
  const user = useUserBase();
  (_a16 = useClerkInstanceContext().telemetry) == null ? void 0 : _a16.record(eventMethodCalled(hookName));
  ...
  function assertReverification(fetcher) {
    return async (...args) => {
      ...
      if (isReverificationHint(result)) {
        ...
        const isValidMetadata = validateReverificationConfig((_a16 = result.clerk_error.metadata) == null ? void 0 : _a16.reverification);
...
function createBillingPaginatedHook({ hookName: hookName$3, resourceType, useFetcher, options }) {
  return function useBillingHook(params) {
    ...
    const user = useUserBase();
    const organization = useOrganizationBase();
    (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled(hookName$3));
...
var useLocalization = () => {
  ...
  let locale = "en";
  try {
    locale = ((_a16 = clerk.__internal_getOption("localization")) == null ? void 0 : _a16.locale) || "en";
  } catch {
  }
...
var PaymentElement = ({ fallback }) => {
  ...
  const applePay = (0, import_react.useMemo)(() => {
    ...
    return { recurringPaymentRequest: {
      ...
      regularBilling: {
        amount: ((_a16 = checkout.totals.totalDueNow) == null ? void 0 : _a16.amount) || checkout.totals.grandTotal.amount,
...
// node_modules/@clerk/react/dist/chunk-GRZDFHDQ.mjs
...
var hasCloudflareProxyContext = (context) => {
  var _a16;
  return !!((_a16 = context == null ? void 0 : context.cloudflare) == null ? void 0 : _a16.env);
};
...
var assertSingleChild = (children) => (name) => {
  try {
    ...
    if (childArray.length === 1 && import_react5.default.isValidElement(childArray[0])) {
      return childArray[0];
    }
...
var useUserButtonCustomMenuItems = (children, options) => {
  ...
  return useCustomMenuItems({
    ...
    allowForAnyChildren: (_a16 = options == null ? void 0 : options.allowForAnyChildren) != null ? _a16 : false
  });
};
...
var waitForElementChildren = createAwaitableMutationObserver({
  ...
  isReady: (el, selector) => {
    var _a16;
    return !!(el == null ? void 0 : el.childElementCount) && ((_a16 = el == null ? void 0 : el.matches) == null ? void 0 : _a16.call(el, selector)) && el.childElementCount > 0;
  }
});
...
var ClerkHostRenderer = class extends import_react13.default.PureComponent {
  ...
  componentDidUpdate(_prevProps) {
    ...
    const customPagesChanged = ((_a16 = prevProps.customPages) == null ? void 0 : _a16.length) !== ((_b = newProps.customPages) == null ? void 0 : _b.length);
...
var CustomPortalsRenderer = (props) => {
  var _a16, _b;
  return import_react4.default.createElement(import_react4.default.Fragment, null, (_a16 = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a16.map((portal, index) => (0, import_react4.createElement)(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react4.createElement)(portal, { key: index })));
};
...
var useAuth = (options = {}) => {
  ...
  (_a16 = isomorphicClerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled("useAuth", { treatPendingAsSignedOut }));
...
function useClerkSignal(signal) {
  ...
  switch (signal) {
    case "signIn":
      (_a16 = clerk.telemetry) == null ? void 0 : _a16.record(eventMethodCalled("useSignIn", { apiVersion: "2025-11" }));
      break;
    case "signUp":
...
// node_modules/@clerk/react/dist/chunk-TXELXGQD.mjs
...
function proxyUrlToAbsoluteURL(url) {
  ...
  if (typeof window === "undefined" || !((_a16 = window.location) == null ? void 0 : _a16.origin)) return url;
...
// node_modules/@clerk/shared/dist/runtime/versionSelector-B60ghK2y.mjs
var versionSelector = (clerkJSVersion, packageVersion = "6.11.1") => {
...
var getPrereleaseTag = (packageVersion) => {
  var _a16;
  return (_a16 = packageVersion.trim().replace(/^v/, "").match(/-(.+?)(\.|$)/)) == null ? void 0 : _a16[1];
};
...
var clerkUIScriptUrl = (opts) => {
  ...
  const version2 = versionSelector(__internal_clerkUIVersion, "1.11.0");
...
var buildScriptHost = (opts) => {
  ...
  if (!!proxyUrl && isValidProxyUrl(proxyUrl)) {
    ...
    if (isProxyUrlRelative(resolvedProxyUrl)) return ((_a16 = parsePublishableKey(publishableKey)) == null ? void 0 : _a16.frontendApi) || "";
...
var RedirectToSignIn = withClerk(({ clerk, ...props }) => {
  ...
  const hasSignedInSessions = ((_b = (_a16 = client.signedInSessions) == null ? void 0 : _a16.length) != null ? _b : 0) > 0;
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  constructor(options) {
    ...
    this.buildSignInUrl = (opts) => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildSignInUrl(opts)) || "";
      };
    ...
    this.buildSignUpUrl = (opts) => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildSignUpUrl(opts)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignInUrl = (...args) => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildAfterSignInUrl(...args)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignUpUrl = (...args) => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildAfterSignUpUrl(...args)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignOutUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildAfterSignOutUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildNewSubscriptionRedirectUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildNewSubscriptionRedirectUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterMultiSessionSingleSignOutUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildAfterMultiSessionSingleSignOutUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildUserProfileUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildUserProfileUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildCreateOrganizationUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildCreateOrganizationUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildOrganizationProfileUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildOrganizationProfileUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildWaitlistUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildWaitlistUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildTasksUrl = () => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildTasksUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildUrlWithAuth = (to) => {
      const callback = () => {
        var _a17;
        return ((_a17 = this.clerkjs) == null ? void 0 : _a17.buildUrlWithAuth(to)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.handleUnauthenticated = async () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.handleUnauthenticated();
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
    ...
    this.on = (...args) => {
      var _a17;
      if ((_a17 = this.clerkjs) == null ? void 0 : _a17.on) {
    ...
    this.off = (...args) => {
      var _a17;
      if ((_a17 = this.clerkjs) == null ? void 0 : _a17.off) {
    ...
    this.replayInterceptedInvocations = (clerkjs) => {
      ...
      (_a17 = __privateGet2(this, _eventBus).internal.retrieveListeners("status")) == null ? void 0 : _a17.forEach((listener) => {
    ...
    this.__experimental_prefetchOrganizationSwitcher = () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.__experimental_prefetchOrganizationSwitcher();
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
      ...
      if (this.clerkjs) {
        ...
        const unsubscribe = () => {
          ...
          if (listenerExtras == null ? void 0 : listenerExtras.handlers) {
            (_b = listenerExtras == null ? void 0 : (_a17 = listenerExtras.handlers).nativeUnsubscribe) == null ? void 0 : _b.call(_a17);
    ...
    this.navigate = (to) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.navigate(to);
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
    ...
    this.redirectWithAuth = async (...args) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectWithAuth(...args);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToSignIn = async (opts) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToSignIn(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToSignUp = async (opts) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToSignUp(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToUserProfile = async () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToUserProfile();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToAfterSignUp = () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToAfterSignUp();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToAfterSignIn = () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToAfterSignIn();
      };
      if (this.clerkjs && this.loaded) {
        callback();
      } else {
    ...
    this.redirectToAfterSignOut = () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToAfterSignOut();
      };
      if (this.clerkjs && this.loaded) {
        callback();
      } else {
    ...
    this.redirectToOrganizationProfile = async () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToOrganizationProfile();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToCreateOrganization = async () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToCreateOrganization();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToWaitlist = async () => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToWaitlist();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToTasks = async (opts) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.redirectToTasks(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.handleRedirectCallback = async (params) => {
      ...
      if (this.clerkjs && this.loaded) {
        void ((_a17 = callback()) == null ? void 0 : _a17.catch(() => {
        }));
      } else {
    ...
    this.handleEmailLinkVerification = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.handleEmailLinkVerification(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithMetamask = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.authenticateWithMetamask(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithCoinbaseWallet = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.authenticateWithCoinbaseWallet(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithBase = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.authenticateWithBase(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithOKXWallet = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.authenticateWithOKXWallet(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithSolana = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.authenticateWithSolana(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithWeb3 = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.authenticateWithWeb3(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.createOrganization = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.createOrganization(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.getOrganization = async (organizationId) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.getOrganization(organizationId);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.joinWaitlist = async (params) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.joinWaitlist(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.signOut = async (...args) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.signOut(...args);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.__internal_attemptToEnableEnvironmentSetting = (options2) => {
      const callback = () => {
        var _a17;
        return (_a17 = this.clerkjs) == null ? void 0 : _a17.__internal_attemptToEnableEnvironmentSetting(options2);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    if (__privateGet2(this, _publishableKey) && ((_a16 = this.options.experimental) == null ? void 0 : _a16.runtimeEnvironment) === "headless" && this.options.Clerk) {
  ...
  get loaded() {
    var _a16;
    return ((_a16 = this.clerkjs) == null ? void 0 : _a16.loaded) || false;
  }
  get status() {
    var _a16;
    if (!this.clerkjs) {
    ...
    return ((_a16 = this.clerkjs) == null ? void 0 : _a16.status) || /**
  ...
  __internal_getOption(key) {
    var _a16, _b;
    return ((_a16 = this.clerkjs) == null ? void 0 : _a16.__internal_getOption) ? (_b = this.clerkjs) == null ? void 0 : _b.__internal_getOption(key) : this.options[key];
  }
  /**
  ...
  get sdkMetadata() {
    var _a16;
    return ((_a16 = this.clerkjs) == null ? void 0 : _a16.sdkMetadata) || this.options.sdkMetadata || void 0;
  }
  get instanceType() {
    var _a16;
    return (_a16 = this.clerkjs) == null ? void 0 : _a16.instanceType;
  }
  get frontendApi() {
    var _a16;
    return ((_a16 = this.clerkjs) == null ? void 0 : _a16.frontendApi) || "";
  }
  get isStandardBrowser() {
    var _a16;
    return ((_a16 = this.clerkjs) == null ? void 0 : _a16.isStandardBrowser) || this.options.standardBrowser || false;
  }
  get isSatellite() {
    if (typeof window !== "undefined" && window.location) {
  ...
  async getEntryChunks() {
    ...
    try {
      ...
      if (!clerk.loaded) {
        ...
        const shouldLoadUi = this.options.standardBrowser !== false && !this.options.Clerk || !!((_a16 = this.options.ui) == null ? void 0 : _a16.ClerkUI);
  ...
  get version() {
    var _a16;
    return (_a16 = this.clerkjs) == null ? void 0 : _a16.version;
  }
  get client() {
    if (this.clerkjs) {
  ...
  get billing() {
    var _a16;
    return (_a16 = this.clerkjs) == null ? void 0 : _a16.billing;
  }
  ...
  get apiKeys() {
    var _a16;
    return (_a16 = this.clerkjs) == null ? void 0 : _a16.apiKeys;
  }
  get oauthApplication() {
    var _a16;
    return (_a16 = this.clerkjs) == null ? void 0 : _a16.oauthApplication;
  }
  ...
  get __internal_lastEmittedResources() {
    var _a16;
    return (_a16 = this.clerkjs) == null ? void 0 : _a16.__internal_lastEmittedResources;
  }
};
...
if (globalThis.__clerkSharedModules) {
  const existingVersion = (_a15 = globalThis.__clerkSharedModules.react) == null ? void 0 : _a15.version;
